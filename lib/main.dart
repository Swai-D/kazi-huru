...
import 'features/job_provider/presentation/screens/job_seeker_profile_screen.dart';
import 'features/job_seeker/presentation/screens/assigned_jobs_screen.dart';
...
void main() async {
  ...
  // Environment variables loading removed - .env file not needed for current setup
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/':
            (context) =>
                const AuthWrapper(), // Main app route - handles authentication routing
        ...
        '/job_provider_dashboard':
            (context) =>
                const JobProviderDashboardScreen(), // Job provider dashboard
        ...
        '/notification-settings':
            (context) =>
                const NotificationSettingsScreen(), // Notification settings
        '/notification-permission':
            (context) =>
                const NotificationPermissionScreen(), // Notification permission
        '/notification-test':
            (context) => const NotificationTestScreen(), // Notification test
        ...
        '/company_profile':
            (context) => const CompanyProfileScreen(), // Company profile
        '/wallet': (context) => const WalletScreen(), // Wallet screen
        '/id-verification':
            (context) => const IdVerificationScreen(), // ID verification
        '/verification-status':
            (context) =>
                const VerificationStatusScreen(), // Verification status
        '/admin-verification':
            (context) => const AdminVerificationScreen(), // Admin verification
        '/applied_jobs':
            (context) => const AppliedJobsScreen(), // Applied jobs list
        '/completed_jobs':
            (context) => const CompletedJobsScreen(), // Completed jobs list
        '/posted_jobs':
            (context) => const PostedJobsScreen(), // Posted jobs list
        '/applications_received':
            (context) =>
                const ApplicationsReceivedScreen(), // Applications received list
        '/payment_details':
            (context) =>
                const WalletScreen(), // Payment details (redirect to wallet)
        '/job_application_details':
            (context) =>
                const JobSeekerDashboardScreen(), // Job application details (redirect to dashboard)
        '/firebase_test':
            (context) => const FirebaseTestScreen(), // Firebase test screen
        '/auth_test': (context) => const AuthTestScreen(), // Auth test screen
        '/job_seeker_profile': (context) {
          final args =
              ModalRoute.of(context)?.settings.arguments
                  as Map<String, dynamic>?;
        ...
        '/assigned-jobs':
            (context) => const AssignedJobsScreen(), // Assigned jobs screen
      },
    );
  }
}
